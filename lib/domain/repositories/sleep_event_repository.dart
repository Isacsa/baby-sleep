...
abstract class SleepEventRepository {
  ...
  Future<Result<List<SleepEvent>, Failure>> getUnsyncedEvents(String babyId);
  ...
  Future<Result<SleepEvent, Failure>> createSleepEvent(SleepEvent event);
  ...
  Future<Result<SleepEvent, Failure>> updateSleepEvent(SleepEvent event);

  /// Gets event by ID
  /// 
  /// Validates user has access via RLS
  Future<Result<SleepEvent?, Failure>> getEventById(String eventId);
}
